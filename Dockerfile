...
# the 512MB free-tier RAM (default is 20; 8 balances speed vs memory — only
# one search runs at a time thanks to the async job design).
ENV SHERLOCK_MAX_WORKERS=8
